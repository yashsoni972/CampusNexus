...
/* ── Section header ── */
const SectionHeader = ({ icon: Icon, title, subtitle, color = 'bg-primary-50 text-primary-600' }) => (
...
export default function EditProfile() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-5 page-enter">
      ...
      {/* ── Top header ── */}
      <div className="flex items-center gap-3" style={{ animation: 'slideUpFade 0.4s cubic-bezier(0.22,1,0.36,1) both' }}>
        <button
      ...
      {/* ── Avatar card ── */}
      <div
        className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover-lift"
      ...
      >
        <div className={`h-16 bg-gradient-to-r ${grad} relative overflow-hidden`}>
          <div className="absolute -right-4 -top-4 w-20 h-20 rounded-full bg-white/10 animate-float" />
        </div>
        <div className="px-5 pb-5 -mt-8 flex items-end gap-4">
          <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${grad} shadow-md border-4 border-white flex items-center justify-center animate-bounce-in flex-shrink-0`}>
      ...
      {/* ── Tabs ── */}
      <div
        className="flex gap-1 bg-gray-100 rounded-2xl p-1"
        style={{ animation: 'slideUpFade 0.45s cubic-bezier(0.22,1,0.36,1) 0.1s both' }}
      >
        {tabs.map(({ id, label, icon: Icon }) => (
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium transition-all duration-200
              ${activeTab === id
                ? 'bg-white text-primary-700 shadow-sm scale-[1.01]'
      ...
      {activeTab === 'profile' && (
        <form
          onSubmit={handleSave}
          className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5 page-enter"
        >
          <SectionHeader
            icon={UserCircleIcon}
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-xl border border-gray-200 bg-white text-sm px-3.5 py-2.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent hover:border-gray-300 resize-none"
              maxLength={500}
            />
          ...
          <div className="flex justify-end gap-3 pt-2 border-t border-gray-50">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-primary-600 to-purple-600 text-white text-sm font-semibold rounded-xl hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed disabled:translate-y-0"
            >
              {saving ? (
                <>
      ...
      {activeTab === 'password' && (
        ...
        >
          ...
          {pwSuccess && (
            <div className="flex items-center gap-2.5 p-3.5 bg-green-50 border border-green-200 rounded-xl text-green-700 text-sm animate-bounce-in">
          ...
          <div className="flex justify-end pt-2 border-t border-gray-50">
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-gray-800 to-gray-900 text-white text-sm font-semibold rounded-xl hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed disabled:translate-y-0"
            >
              {changingPw ? (
                <>
                  <svg className="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
